        ...
        <form id="order_info">
            <ul>
                ...
                <li>
                    ...
                    <div class="info_group">
                        <label>房费总计</label><span style="color:#999;font-family: arial;text-decoration: line-through;">￥${roomType.prePrice}</span><span class="total">￥</span>
                            <span class="total" name="price" id="price">${roomType.laterPrice} </span><span class="total"> /天</span>
