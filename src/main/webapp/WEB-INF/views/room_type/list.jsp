	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td valign="middle">
                	<img id="preview-photo" style="float:left;" src="/easyui/images/hotel.jpg" width="100px">
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
            ...
            <tr>
                <td width="60" align="right">房型图片:</td>
                <td><input type="text" id="edit-photo" name="photo" value="/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
           <tr>
                <td align="right">名称:</td>
