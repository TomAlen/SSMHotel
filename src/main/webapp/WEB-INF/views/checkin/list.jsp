	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
	                <select id="add-roomTypeId" name="roomTypeId" class="easyui-combobox" panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择房型'">
		            	<c:forEach items="${roomTypeList}" var="roomType">
		            	    <option value="${roomType.id }" roomtype-price="${roomType.price}">${roomType.name }</option>
		            	</c:forEach>
	            	</select>	
                </td>
                <td></td>
            ...
            <tr>
                ...
                <td><input type="text" id="add-arriveTime" name="arriveTime" class="wu-text easyui-datebox easyui-validatebox"  /></td>
            	<td></td>
            </tr>
            <tr>
                <td align="right">离店日期:</td>
                <td><input type="text" id="add-leaveTime" name="leaveTime" class="wu-text easyui-datebox easyui-validatebox"  /></td>
            	<td></td>
            </tr>
            <tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           ...
           <tr>
            ...
            <tr>
                <td align="right">入住价格:</td>
                <td><input type="text" id="edit-checkinPrice" name="checkinPrice" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请输入入住价格'" /></td>
            </tr>
            <tr>
                <td align="right">入住人姓名:</td>
