	...
	<form id="add-form" method="post">
        <table>
           ...
           <%-- <tr>
                ...
                <td>
                    <input type="text" name="price" id="add-price" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请输入价格'">
                </td>
            </tr>--%>
            <tr>
        ...
        <table>
           <tr>
            ...
            <%--<tr>
                <td align="right">价格:</td>
                <td>
                    <input type="text" name="price" id="edit-price" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请输入价格'">
                </td>
            </tr>--%>
            <tr>
                <td align="right">入住人姓名:</td>
...
<script type="text/javascript">
	...
	*/
	...
	/**
     * 根据客户名来获取真实姓名、身份证号、手机号自动填入添加框和编辑框。
    * */
    ...
    $("#add-roomTypeId").combobox({
        onSelect:function(data){
            ...
            $("#add-price").val(option.attr('roomPrice'));
        }
    });
    ...
    $('#edit-roomTypeId').combobox({
        onSelect:function (data) {
            ...
            var option = $("#add-roomTypeId option[value='" + data.value + "']");
            //拿到自定义的属性值
            $('#edit-price').val(option.attr('roomPrice'));
        }
