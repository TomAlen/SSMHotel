...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2013, TomAlen, Ltd." />
<title>酒店后台管理系统主页</title>
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
     <img src="/easyui/images/loading.jpg" width="20%">
</div> 
	<!-- begin of header -->
	<div class="wu-header" data-options="region:'north',border:false,split:true">
        ...
        <div class="wu-header-right">
            ...
            <p><a href="https://www.zwhzzz.top">个人博客</a>|<a href="logout">安全退出</a></p>
        </div>
    </div>
    <!-- end of header -->
    <!-- begin of sidebar -->
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 2019-2020 【钟炜宏-毕业设计】 All Rights Reserved
    </div>
    <!-- end of footer -->  
